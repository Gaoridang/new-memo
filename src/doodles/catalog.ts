...
export const DOODLES = {
  ...
  bear: '곰·곰돌이·곰인형 (bear, teddy bear)',
  pig: '돼지·돼지저금통 (pig, piggy bank)',
  hamster: '햄스터·기니피그 (hamster, guinea pig)',
  panda: '판다·푸바오 (panda)',
  chick: '병아리·새·참새·앵무새 (chick, bird, parrot)',
  penguin: '펭귄 (penguin)',
  fish: '물고기·금붕어·어항·수족관·낚시·생선 (fish, goldfish, aquarium, fishing)',
  turtle: '거북이·거북 (turtle, tortoise)',
  ...
  tv: 'TV·티비·텔레비전 (TV, television)',
  fridge: '냉장고·냉동실·김치냉장고 (fridge, refrigerator, freezer)',
  washer: '세탁기·건조기 (washing machine, clothes dryer)',
  microwave: '전자레인지·오븐·에어프라이어 (microwave, oven, air fryer)',
  ricecooker: '밥솥·전기밥솥 (rice cooker)',
  aircon: '에어컨·냉방 (air conditioner, AC)',
  fan: '선풍기·서큘레이터 (electric fan)',
  vacuum: '청소기·로봇청소기 (vacuum cleaner, robot vacuum)',
  battery: '충전기·배터리·보조배터리·건전지 (charger, battery, power bank)',
  toothbrush: '칫솔·치약·양치 (toothbrush, toothpaste)',
  soap: '비누·샴푸·린스·바디워시·세제·손 씻기 (soap, shampoo, detergent, hand washing)',
  tissue: '휴지·화장지·티슈·물티슈·키친타월 (tissue, toilet paper, paper towel)',
  trash: '쓰레기·쓰레기통·쓰레기봉투·음식물 쓰레기 (trash, garbage, trash can)',
  key: '열쇠·키·자물쇠·도어락 (key, lock)',
  mask: '마스크 (face mask)',
  glasses: '안경·선글라스·렌즈·안과 (glasses, sunglasses, contact lenses)',
  scissors: '가위·미용실·머리 자르기 (scissors, haircut, hair salon)',
  bed: '침대·이불·베개·매트리스 (bed, blanket, pillow, mattress)',
