...
export function BoldIcon({ color }: IconProps) {
  return (
    <Icon>
      <Path
...
export function UnderlineIcon({ color }: IconProps) {
  return (
    <Icon>
      <Path
...
export function StrikethroughIcon({ color }: IconProps) {
  return (
    <Icon>
      <Path
...
export function CheckboxIcon({ color }: IconProps) {
  return (
    <Icon>
...
export function BulletListIcon({ color }: IconProps) {
  return (
    <Icon>
...
export function NumberedListIcon({ color }: IconProps) {
  return (
    <Icon>
      <Path
...
function KeyboardBody({ color }: IconProps) {
  return (
    <>
...
export function KeyboardDismissIcon({ color }: IconProps) {
  return (
    <Icon>
      <KeyboardBody color={color} />
      <Path d="M7.75 15.1L10 17.1L12.25 15.1" {...strokeProps(color)} />
    </Icon>
  );
}

export function KeyboardShowIcon({ color }: IconProps) {
  return (
    <Icon>
      <KeyboardBody color={color} />
      <Path d="M7.75 17.1L10 15.1L12.25 17.1" {...strokeProps(color)} />
    </Icon>
  );
}
