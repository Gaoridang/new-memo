...
const CRITERIA = {
  ...
  // 약속을 적지 않으면 '월요일 10시 회의', '금요일 팀 회식' 같은 일정 목록이 글머리표가 됐다.
  todo: '작성자나 담당자가 해야 할 일. 장보기 목록에 적은 살 물건("우유", "세제")도 할 일이다. 담당자가 붙은 업무도 할 일이다. 작성자가 정해진 때에 가거나 참석할 약속·일정·회의("6시 저녁약속", "금요일 팀 회식")도 할 일이다',
};
